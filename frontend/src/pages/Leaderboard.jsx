  ...
  return (
    <motion.div variants={containerVariants} initial="hidden" animate="visible" className="max-w-4xl mx-auto space-y-6">
            ...
            return (
              <motion.div
                ...
                className={`glass-card p-4 flex items-center gap-4 transition-all duration-300 ${
                  isCurrentUser ? 'ring-2 ring-purple-500 bg-purple-500/5' : ''
                }`}
              >
                ...
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-primary-500 to-purple-500 flex items-center justify-center text-white font-bold text-sm shrink-0">
      ...
      {ranking && ranking.rank && ranking.rank > 20 && (
        <motion.div variants={itemVariants} className="glass-card p-4 flex items-center gap-4 ring-2 ring-purple-500 bg-purple-500/5">
          <div className="w-10 text-center">
