...
const ProtectedRoute = ({ children }) => {
  ...
  if (loading) return (
    <div className="min-h-screen flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #EFF6FF 0%, #DBEAFE 30%, #F3E8FF 65%, #ECFEFF 100%)' }}>
        ...
        <Router>
          <div className="min-h-screen text-[var(--text-primary)] transition-colors duration-300 relative">
            <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
              ...
              <div className="stem-deco w-[1px] h-32 bg-gradient-to-b from-transparent via-purple-300/8 to-transparent top-[50%] right-[40%] -rotate-30" />
