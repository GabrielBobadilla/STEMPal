...
db.insert('users', { fullname: 'STEMPal Admin', email: 'admin@stempal.com', password: '$2a$10$Fyy7rHPQQQ3H6P.PBcvT7Omyd4WbrmHylN2dpvJEE2O9Zsru2Lm3q', role: 'admin', profile_picture: 'default.png', notification_enabled: 1, total_xp: 0, level: 1, theme_preference: 'light' });
db.insert('users', { fullname: 'Juan Dela Cruz', email: 'juan@gmail.com', password: '$2a$10$DfWekcLsJkMyyWJcRQrrD.S8DCkta1s27sf8cMmlRZAS1mrmaHzWi', role: 'student', profile_picture: 'default.png', notification_enabled: 1, total_xp: 0, level: 1, theme_preference: 'light' });
